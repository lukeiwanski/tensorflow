...
def tf_workspace(path_prefix="", tf_repo_name=""):
  ...
  acl_repository(
      name = "acl",
      urls = [
          "https://github.com/lukeiwanski/ComputeLibrary/archive/f8c0e7f02a56e900a3e592be6917e7c27b94ef64.tar.gz",
      ],
      strip_prefix = "ComputeLibrary-f8c0e7f02a56e900a3e592be6917e7c27b94ef64",
